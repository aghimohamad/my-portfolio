...
function Project({project}) {
  return (
    <div className='flex flex-col md:flex-row justify-around my-12 items-center'>
        ...
        <div className='relative group md:w-[45%] rounded-3xl overflow-hidden hover:-translate-y-5 hover:opacity-90 cursor-pointer  transition-all duration-200 w-64'>
                    <img src={project.image} alt="" className='  transition-all duration-200 hover:blur-sm  '/>
